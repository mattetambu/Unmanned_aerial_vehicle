...
#define TOPIC_VEHICLE_LOCAL_POSITION_H_
	...
	{
		absolute_time timestamp;		/**< Time of this estimate, in microseconds since system start */
		...
		absolute_time ref_timestamp;	/**< Time when reference position was set */
		...
		/* Distance to surface */
		bool_t dist_bottom_valid;	/**< true if distance to bottom surface is valid */
