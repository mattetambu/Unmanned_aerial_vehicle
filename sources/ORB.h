...
#define _ORB_H_
	...
	# define ORB_DECLARE_OPTIONAL(_name)	extern struct orb_metadata __orb_##_name __attribute__((weak))
	...
	orb_advert_t orb_advertise (struct orb_metadata *meta, pid_t pid);
	orb_subscr_t orb_subscribe (struct orb_metadata *meta, pid_t pid);
	int orb_unadvertise (const struct orb_metadata *meta, orb_advert_t advertiser);
	int orb_unsubscribe (const struct orb_metadata *meta, orb_subscr_t subscriber);
	...
	int orb_stat (const struct orb_metadata *meta, orb_subscr_t subscriber, uint32_t *last_publish);
